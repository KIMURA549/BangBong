...
void Fade::Init()
{
	...
	//ここにシェーダーファイルのロードを追加
	Renderer::CreateVertexShader(&m_VertexShader, &m_VertexLayout, "shader\\wipeVS.cso");
	Renderer::CreatePixelShader(&m_PixelShader, "shader\\wipePS.cso");

	SetFadeState(FADESTATE_FADEIN);
}
...
void Fade::Draw()
{
	...
	param.Parameter[0] = m_threshold;
	param.Parameter[1] = 0.1f;
...
void Fade::SetFadeTexture(const char* textureName)
{
	VERTEX_3D vertex[4];
